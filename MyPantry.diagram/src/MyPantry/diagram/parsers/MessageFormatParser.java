 ...
 * 
 */
package MyPantry.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(MyPantry.diagram.part.MyPantryDiagramEditorPlugin.ID,
					IParserEditStatus.UNEDITABLE,
					NLS.bind(MyPantry.diagram.part.Messages.MessageFormatParser_InvalidInputError,
