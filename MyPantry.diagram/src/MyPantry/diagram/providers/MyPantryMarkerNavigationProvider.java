 ...
 * @generated
 */
public class MyPantryMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {

	/**
	* @generated
	*/
	public static final String MARKER_TYPE = MyPantry.diagram.part.MyPantryDiagramEditorPlugin.ID + ".diagnostic"; //$NON-NLS-1$
	...
	*/
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			MyPantry.diagram.part.MyPantryDiagramEditorUtil.selectElementsInDiagram(editor,
