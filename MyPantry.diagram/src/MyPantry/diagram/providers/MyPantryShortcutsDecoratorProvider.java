 ...
 * @generated
 */
public class MyPantryShortcutsDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	protected class ShortcutsDecorator extends AbstractDecorator {
		...
		*/
		public void refresh() {
			...
			Image image = MyPantry.diagram.part.MyPantryDiagramEditorPlugin.getInstance()
