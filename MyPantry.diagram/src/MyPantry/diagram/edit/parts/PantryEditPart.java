 ...
 * @generated
 */
public class PantryEditPart extends DiagramEditPart {

	/**
	* @generated
	*/
	public final static String MODEL_ID = "MyPantry"; //$NON-NLS-1$
	...
	* @generated
	*/
	public PantryEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new MyPantry.diagram.edit.policies.PantryItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new MyPantry.diagram.edit.policies.PantryCanonicalEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicyWithCustomReparent(
				MyPantry.diagram.part.MyPantryVisualIDRegistry.TYPED_INSTANCE));
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command.chain(new ICommandProxy(
							new MyPantry.diagram.edit.commands.MyPantryCreateShortcutDecorationsCommand(
