...
public class IngredientNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new MyPantry.diagram.edit.policies.MyPantryTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return MyPantry.diagram.providers.MyPantryElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MyPantry.diagram.providers.MyPantryParserProvider.getParser(
					MyPantry.diagram.providers.MyPantryElementTypes.Ingredient_2001, getParserElement(),
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					MyPantry.diagram.edit.parts.MyPantryEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
