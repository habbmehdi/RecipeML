	...
	private static class OpenDiagramCommand extends AbstractTransactionalCommand {
		...
		*/
		OpenDiagramCommand(HintedDiagramLinkStyle linkStyle) {
			...
			super(TransactionUtil.getEditingDomain(linkStyle), MyPantry.diagram.part.Messages.CommandName_OpenDiagram,
					null);
		...
		*/
		protected String getEditorID() {
			return MyPantry.diagram.part.MyPantryDiagramEditor.ID;
		}
	}
