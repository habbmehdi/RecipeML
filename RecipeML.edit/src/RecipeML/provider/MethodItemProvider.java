...
/**
 * This is the item provider adapter for a {@link RecipeML.Method} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MethodItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RecipeMLPackage.Literals.METHOD__NAME,
				 true,
				 false,
				 false,
	...
	protected void addTimePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Method_time_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Method_time_feature", "_UI_Method_type"),
				 RecipeMLPackage.Literals.METHOD__TIME,
				 true,
				 false,
				 false,
	...
	protected void addStepPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Method_step_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Method_step_feature", "_UI_Method_type"),
				 RecipeMLPackage.Literals.METHOD__STEP,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RecipeMLPackage.Literals.METHOD__CREATES);
			childrenFeatures.add(RecipeMLPackage.Literals.METHOD__USES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RecipeMLPackage.Literals.METHOD__CREATES,
				 RecipeMLFactory.eINSTANCE.createModIng()));

		newChildDescriptors.add
			(createChildParameter
				(RecipeMLPackage.Literals.METHOD__USES,
				 RecipeMLFactory.eINSTANCE.createAmount()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return RecipeMLEditPlugin.INSTANCE;
	}
