...
/**
 * This is the item provider adapter for a {@link RecipeML.Recipe} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RecipeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RecipeMLPackage.Literals.RECIPE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addServesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Recipe_serves_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Recipe_serves_feature", "_UI_Recipe_type"),
				 RecipeMLPackage.Literals.RECIPE__SERVES,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RecipeMLPackage.Literals.RECIPE__BASEINGS);
			childrenFeatures.add(RecipeMLPackage.Literals.RECIPE__METHODS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RecipeMLPackage.Literals.RECIPE__BASEINGS,
				 RecipeMLFactory.eINSTANCE.createBaseIng()));

		newChildDescriptors.add
			(createChildParameter
				(RecipeMLPackage.Literals.RECIPE__METHODS,
				 RecipeMLFactory.eINSTANCE.createMethod()));
	}
