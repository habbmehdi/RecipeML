 ...
 * @generated
 */
public class RecipeMLValidationDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	* @generated
	*/
	private static final String MARKER_TYPE = RecipeML.diagram.part.RecipeMLDiagramEditorPlugin.ID + ".diagnostic"; //$NON-NLS-1$
	...
	*/
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart || editPart instanceof AbstractConnectionEditPart) {
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof RecipeML.diagram.part.RecipeMLDiagramEditor) {
	...
	*/
	public boolean provides(IOperation operation) {
		...
		return view != null && RecipeML.diagram.edit.parts.RecipeEditPart.MODEL_ID
		...
		*/
		public StatusDecorator(IDecoratorTarget decoratorTarget) {
			...
			try {
				...
				RecipeML.diagram.part.RecipeMLDiagramEditorPlugin.getInstance().logError("ViewID access failure", e); //$NON-NLS-1$			
			}
		}
