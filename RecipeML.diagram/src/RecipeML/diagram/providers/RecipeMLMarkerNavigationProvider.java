 ...
 * @generated
 */
public class RecipeMLMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {

	/**
	* @generated
	*/
	public static final String MARKER_TYPE = RecipeML.diagram.part.RecipeMLDiagramEditorPlugin.ID + ".diagnostic"; //$NON-NLS-1$
	...
	*/
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			RecipeML.diagram.part.RecipeMLDiagramEditorUtil.selectElementsInDiagram(editor,
