 ...
 * @generated
 */
public class RecipeMLShortcutsDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	protected class ShortcutsDecorator extends AbstractDecorator {
		...
		*/
		public void refresh() {
			...
			Image image = RecipeML.diagram.part.RecipeMLDiagramEditorPlugin.getInstance()
