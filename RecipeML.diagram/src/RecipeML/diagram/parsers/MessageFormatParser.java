 ...
 * 
 */
package RecipeML.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(RecipeML.diagram.part.RecipeMLDiagramEditorPlugin.ID,
					IParserEditStatus.UNEDITABLE,
					NLS.bind(RecipeML.diagram.part.Messages.MessageFormatParser_InvalidInputError,
