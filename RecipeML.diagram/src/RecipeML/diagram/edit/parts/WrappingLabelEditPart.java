...
public class WrappingLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(RecipeML.diagram.part.RecipeMLVisualIDRegistry
				.getType(RecipeML.diagram.edit.parts.WrappingLabelEditPart.VISUAL_ID), new Point(0, 40));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = RecipeML.diagram.providers.RecipeMLParserProvider.getParser(
					RecipeML.diagram.providers.RecipeMLElementTypes.IngredientAmount_4010, getParserElement(),
