 ...
 * @generated
 */
public class RecipeEditPart extends DiagramEditPart {

	/**
	* @generated
	*/
	public final static String MODEL_ID = "RecipeML"; //$NON-NLS-1$
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new RecipeML.diagram.edit.policies.RecipeItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new RecipeML.diagram.edit.policies.RecipeCanonicalEditPolicy());
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command.chain(new ICommandProxy(
							new RecipeML.diagram.edit.commands.RecipeMLCreateShortcutDecorationsCommand(
