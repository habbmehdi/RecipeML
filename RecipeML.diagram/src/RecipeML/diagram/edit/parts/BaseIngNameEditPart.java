 ...
 * @generated
 */
public class BaseIngNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public BaseIngNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new RecipeML.diagram.edit.policies.RecipeMLTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return RecipeML.diagram.providers.RecipeMLElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = RecipeML.diagram.providers.RecipeMLParserProvider.getParser(
					RecipeML.diagram.providers.RecipeMLElementTypes.BaseIng_2001, getParserElement(),
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					RecipeML.diagram.edit.parts.RecipeMLEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
