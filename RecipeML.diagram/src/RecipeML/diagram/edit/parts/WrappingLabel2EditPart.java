	...
	*/
	static {
		registerSnapBackPosition(RecipeML.diagram.part.RecipeMLVisualIDRegistry
				.getType(RecipeML.diagram.edit.parts.WrappingLabel2EditPart.VISUAL_ID), new Point(0, 40));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = RecipeML.diagram.providers.RecipeMLParserProvider.getParser(
					RecipeML.diagram.providers.RecipeMLElementTypes.AmountAmountof_4011, getParserElement(),
