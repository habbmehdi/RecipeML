 ...
 * @generated
 */
public class ModIngNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ModIngNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = RecipeML.diagram.providers.RecipeMLParserProvider.getParser(
					RecipeML.diagram.providers.RecipeMLElementTypes.ModIng_3001, getParserElement(),
