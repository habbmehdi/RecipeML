 ...
 * @generated
 */
public class AmountNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AmountNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = RecipeML.diagram.providers.RecipeMLParserProvider.getParser(
					RecipeML.diagram.providers.RecipeMLElementTypes.Amount_3002, getParserElement(),
