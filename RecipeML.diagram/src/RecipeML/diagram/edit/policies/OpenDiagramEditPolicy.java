	...
	private static class OpenDiagramCommand extends AbstractTransactionalCommand {
		...
		*/
		OpenDiagramCommand(HintedDiagramLinkStyle linkStyle) {
			...
			super(TransactionUtil.getEditingDomain(linkStyle), RecipeML.diagram.part.Messages.CommandName_OpenDiagram,
					null);
		...
		*/
		protected String getEditorID() {
			return RecipeML.diagram.part.RecipeMLDiagramEditor.ID;
		}
	}
