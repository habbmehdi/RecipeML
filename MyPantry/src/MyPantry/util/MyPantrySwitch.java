 ...
 * @generated
 */
public class MyPantrySwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MyPantryPackage.PANTRY: {
				Pantry pantry = (Pantry)theEObject;
				T result = casePantry(pantry);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Pantry</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Pantry</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePantry(Pantry object) {
		return null;
	}
